...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      'Perro': ( _ ) => const Animalperro(), //Muestra la ruta dela Practica perro
      'Gallina': ( _ ) => const Animalgallina(), //Muestra la ruta dela Practica gallina
      'Cerdo': ( _ ) => const Animalcerdo(), //Muestra la ruta dela Practica cerdo
