...
class HomePage extends StatefulWidget {
 ...
 Future<void> signOut() async {
     await Auth().signOut();
      ...
      padding:
          EdgeInsets.symmetric(horizontal: 60, vertical: 13), //Ancho y Alto
    );
    ...
    final ButtonStyle btnNumeros = ElevatedButton.styleFrom(
        ...
        onPrimary: Colors.white, //color del texto del btn
        padding:
            EdgeInsets.symmetric(horizontal: 57, vertical: 13) //Ancho y Alto
        );
    //ESTILO BOTON LETRAS
    final ButtonStyle btnLetras = ElevatedButton.styleFrom(
        ...
        onPrimary: Colors.white, //color del texto del btn);
        padding:
            EdgeInsets.symmetric(horizontal: 76, vertical: 13) //Ancho y Alto
        );
    ...
    final ButtonStyle btnPractica = ElevatedButton.styleFrom(
      ...
      onPrimary: Colors.white, //color del texto del btn);
      padding:
          EdgeInsets.symmetric(horizontal: 40, vertical: 13), //Ancho y Alto
    );
    ...
    final ButtonStyle btnSalir = ElevatedButton.styleFrom(
      ...
      onPrimary: Colors.white, //color del texto del btn);
      padding:
          EdgeInsets.symmetric(horizontal: 30, vertical: 14), //Ancho y Alto
    );
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushReplacementNamed( context, 'Rojo' ); //Manda a llamar la pantalla con la ruta Practica del main
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    style: btnPractica,
                    onPressed: () {
                       Navigator.pushReplacementNamed( context, 'Cero' ); //Manda a llamar la pantalla con la ruta Practica del main
                    },
                    child: const Text('P'),
                  ),
                ],
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                       ...
                       Navigator.pushReplacementNamed( context, 'A' ); //Manda a llamar la pantalla con la ruta Practica del main
                    },
                    child: const Text('P'),
                  ),
                ],
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                       ...
                       Navigator.pushReplacementNamed( context, 'Gato' ); //Manda a llamar la pantalla con la ruta Practica del main
                    },
                    child: const Text('P'),
                  ),
                ],
