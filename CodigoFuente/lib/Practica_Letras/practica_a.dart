...
class Letraa extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Letraa ({super.key});

  @override
  State<Letraa> createState() => _LetraatState();
}

class _LetraatState extends State<Letraa> {
 ...
 return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(204, 4, 0, 255),
                  ...
                  Text(
                   ...
                   'LETRA "A" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 4, 0, 255)),
                  ),
                ],
              )
            ],
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-letras/letra-a.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
