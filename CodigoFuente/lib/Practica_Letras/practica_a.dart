...
class Letraa extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontSize: 40,
                            color: Color.fromARGB(204, 4, 0, 255)),
                      ),
                    ],
                  )
                ],
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Home'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'E'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
