...
class Letrao extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Letrao ({super.key});

  @override
  State<Letrao> createState() => _LetraotState();
}

class _LetraotState extends State<Letrao> {
...
return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(204, 255, 13, 0),
                  ...
                  Text(
                   ...
                   'LETRA "O" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 255, 13, 0)),
                  ),
                ],
              )
            ],
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-letras/letra-o.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    Navigator.pushReplacementNamed(context, 'U'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                    },
