...
class Letrau extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Letrau ({super.key});

  @override
  State<Letrau> createState() => _LetrautState();
}

class _LetrautState extends State<Letrau> {
...
return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(255, 181, 107, 9),
                  ...
                  Text(
                   ...
                   'LETRA "U" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(255, 181, 107, 9)),
                  ),
                ],
              )
            ],
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-letras/letra-u.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
