...
class Letrau extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontSize: 40,
                            color: Color.fromARGB(255, 181, 107, 9)),
                      ),
                    ],
                  )
                ],
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'O'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'A'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
