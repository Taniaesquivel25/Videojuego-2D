...
class Animalcerdo extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
                  ...
                  Text(
                   ...
                   'ANIMAL "CERDO" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(255, 137, 10, 80),),
                  ),
                ],
              )
            ],
