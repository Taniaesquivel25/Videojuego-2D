...
class Animalvaca extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Animalvaca({super.key});

  @override
  State<Animalvaca> createState() => _AnimalvacatState();
}

class _AnimalvacatState extends State<Animalvaca> {
                  ...
                  Text(
                   ...
                   'ANIMAL "VACA" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(255, 255, 0, 255)),
                  ),
                ],
              )
            ],
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-animales/animal-vaca.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    Navigator.pushReplacementNamed( context, 'Gato' ); //Manda a llamar la pantalla de regreso con la ruta Practica del main
