...
class Animalperro extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Animalperro({super.key});

  @override
  State<Animalperro> createState() => _AnimalperrotState();
}

class _AnimalperrotState extends State<Animalperro> {
                  ...
                  Text(
                   ...
                   'ANIMAL "PERRO" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(255, 255, 17, 0),),
                  ),
                ],
              )
            ],
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-animales/animal-perro.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    Navigator.pushReplacementNamed( context, 'Gallina' ); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                    },
