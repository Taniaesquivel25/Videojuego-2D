...
class Numerodos extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontSize: 40,
                          color: Color.fromARGB(204, 0, 255, 30),
                        ),
                      ),
                    ],
                  )
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Uno'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Tres'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
