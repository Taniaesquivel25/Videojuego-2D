...
class Numerodos extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Numerodos ({super.key});

  @override
  State<Numerodos> createState() => _NumerodostState();
}

class _NumerodostState extends State<Numerodos> {
   ...
   return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(204, 0, 255, 30),
                  ...
                  Text(
                   ...
                   'NUMERO "DOS" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 0, 255, 30),
            ),
                  ),
                ],
              )
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-numeros/numero-2.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
