...
class Numerosiete extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Numerosiete  ({super.key});

  @override
  State<Numerosiete> createState() => _NumerosietetState();
}

class _NumerosietetState extends State<Numerosiete> {
 ...
 return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(204, 118, 112, 118),
                  ...
                  Text(
                   ...
                   'NUMERO "SIETE"',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 118, 112, 118),
            ),
                  ),
                ],
              )
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-numeros/numero-7.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
