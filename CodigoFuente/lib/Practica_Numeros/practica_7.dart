...
class Numerosiete extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontSize: 40,
                          color: Color.fromARGB(204, 118, 112, 118),
                        ),
                      ),
                    ],
                  )
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Seis'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Ocho'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
