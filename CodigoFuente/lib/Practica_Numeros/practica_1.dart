...
class Numerouno extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Numerouno ({super.key});

  @override
  State<Numerouno> createState() => _NumerounotState();
}

class _NumerounotState extends State<Numerouno> {
   ...
   return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(204, 255, 0, 0),
                  ...
                  Text(
                   ...
                   'NUMERO "UNO" ',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 255, 0, 0),
            ),
                  ),
                ],
              )
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-numeros/numero-1.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
