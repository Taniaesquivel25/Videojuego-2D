...
class Numeroocho extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontSize: 40,
                          color: Color.fromARGB(255, 190, 137, 4),
                        ),
                      ),
                    ],
                  )
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Siete'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Nueve'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
