...
class Numeroseis extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Numeroseis  ({super.key});

  @override
  State<Numeroseis > createState() => _NumeroseistState();
}

class _NumeroseistState extends State<Numeroseis> {
 ...
 return Scaffold(
      appBar: AppBar(
         centerTitle: true,
            ...
            backgroundColor: Color.fromARGB(255, 0, 17, 250),
                  ...
                  Text(
                   ...
                   'NUMERO "SEIS"',
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(255, 0, 17, 250),
            ),
                  ),
                ],
              )
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-numeros/numero-6.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
