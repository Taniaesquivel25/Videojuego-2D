...
class Azul extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40, color:Color.fromARGB(204, 4, 16, 255),
            ),
                  ),
                ],
              )
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                               ...
                               Navigator.pushReplacementNamed( context, 'Rojo' ); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                    },
