...
class Rojo extends StatefulWidget {
...
final ButtonStyle btnMenu_Principal = ElevatedButton.styleFrom(
  ...
  padding: EdgeInsets.symmetric(horizontal: 10, vertical: 13), //Ancho y Alto
);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Home'); //Manda a llamar la pantalla de regreso con la ruta Home del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Rosa'); //Manda a llamar la pantalla con la ruta ROSA del main
                        },
