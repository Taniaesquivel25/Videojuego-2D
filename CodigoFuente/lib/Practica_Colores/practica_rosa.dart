...
class Rosa extends StatefulWidget {
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontSize: 40,
                            color: Color.fromARGB(255, 255, 19, 192)),
                      ),
                    ],
                  )
                ],
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Rojo'); //Manda a llamar la pantalla de regreso con la ruta Home del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Salmon'); //Manda a llamar la pantalla con la ruta ROSA del main
                        },
