...
class Salmon extends StatefulWidget { //Se le cambia el nombre a nuestro stateFulwidget para mandarlo a llamar en nuestras rutas en este caso PRACTICA()
  const Salmon({super.key});

  @override
  State<Salmon> createState() => _SalmontState();
}

class _SalmontState extends State<Salmon> {
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Image.asset(
                  'assets/practica-colores/salmon.png'), //Manda a llamara la imagen de la carpeta assets
                ],
              )
            ],
          ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    style: btnAnterior,
                    onPressed: () {
                       Navigator.pushReplacementNamed( context, 'Rosa' ); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                       ...
                       Navigator.pushReplacementNamed( context, 'Verde' ); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                    },
