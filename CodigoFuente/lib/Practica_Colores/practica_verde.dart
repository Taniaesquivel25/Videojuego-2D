                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontSize: 40,
                          color: Color.fromARGB(204, 17, 255, 0),
                        ),
                      ),
                    ],
                  )
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Salmon'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacementNamed(context,
                              'Azul'); //Manda a llamar la pantalla de regreso con la ruta Practica del main
                        },
